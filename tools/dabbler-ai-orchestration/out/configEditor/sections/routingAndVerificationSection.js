...
function render(state) {
    ...
    const localRouting = (0, helpers_1.getByPath)(state.localOverrides, "routing.outsourcing_mode");
    const sharedRouting = (0, helpers_1.getByPath)(state.routerConfig, "routing.outsourcing_mode");
    const effectiveRouting = (typeof localRouting === "string" ? localRouting : null) ??
        (typeof sharedRouting === "string" ? sharedRouting : null) ??
        "whenever-helpful";
    const routingSource = (0, helpers_1.fieldSource)(state, "routerConfig", "routing.outsourcing_mode", "routing.outsourcing_mode", true);
    const verification = (0, helpers_1.getByPath)(state.budget, "verification_method");
    const effectiveVerification = typeof verification === "string" ? verification : "api";
    const verificationSource = (0, helpers_1.fieldSource)(state, "budget", "verification_method", "", false);
...
<div class="section-block">
  ...
  <div class="field-row">
    ...
    ${(0, helpers_1.indicatorHtml)(routingSource, "outsourcingMode")}
  </div>
</div>
...
<div class="section-block">
  ...
  <div class="field-row">
    ...
    ${(0, helpers_1.indicatorHtml)(verificationSource, "verificationMethod")}
  </div>
...
//# sourceMappingURL=routingAndVerificationSection.js.map