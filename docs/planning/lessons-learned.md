...
(metadata, citation, archival, ceilings) is the lifecycle doc under
`docs/` (Set 064 D8).
...
size: 15,232 bytes / 273 lines / ~3,797 tokens
ceiling: 10,000 tokens   status: OK (38% of ceiling)
...
<!-- lesson: id="L-064-7" status="active" scope="portable" -->
