...
**Builds on:** [`../2026-05-18-custom-tree-pivot/proposal.md`](../2026-05-18-custom-tree-pivot/proposal.md)
  (the macro pivot proposal — pivot-itself decision is locked) and
  [`../2026-05-18-custom-tree-pivot/synthesis.md`](../2026-05-18-custom-tree-pivot/synthesis.md)
...
### `SessionSetsModel.ts` (131 LOC, [src/providers/SessionSetsModel.ts](../../../tools/dabbler-ai-orchestration/src/providers/SessionSetsModel.ts))
...
### `orchestratorIndicatorProvider.ts` (998 LOC, [src/providers/orchestratorIndicatorProvider.ts](../../../tools/dabbler-ai-orchestration/src/providers/orchestratorIndicatorProvider.ts))
...
[src/test/playwright/orchestrator-indicator.spec.ts](../../../tools/dabbler-ai-orchestration/src/test/playwright/orchestrator-indicator.spec.ts)
(751 LOC) and [src/test/playwright/treeView.spec.ts](../../../tools/dabbler-ai-orchestration/src/test/playwright/treeView.spec.ts)
(265 LOC) cover the current dual-view surface. S4 collapses to one
spec file covering the unified webview surface. Other Playwright
specs ([loading-state](../../../tools/dabbler-ai-orchestration/src/test/playwright/loading-state.spec.ts),
[migration-cta](../../../tools/dabbler-ai-orchestration/src/test/playwright/migration-cta.spec.ts))
have selectors that need updating because the rendered DOM moves
from native-tree-item to webview-`<div>`.
